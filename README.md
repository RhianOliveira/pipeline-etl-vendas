# Pipeline de ETL Automatizado para Dados de Vendas 📊

Este projeto foi desenvolvido para simular um cenário real de negócios, onde dados de vendas e clientes vindos de planilhas dispersas e bagunçadas são extraídos, limpos e centralizados em um banco de dados relacional para análise de Business Intelligence.
